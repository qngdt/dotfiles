...
vim.keymap.set('n', 'J', '<C-d>zz', { desc = 'Fast down' })
vim.keymap.set('n', 'K', '<C-u>zz', { desc = 'Fast up' })
vim.keymap.set('n', '<C-d>', '<C-d>zz', { desc = 'Fast down' })
vim.keymap.set('n', '<C-u>', '<C-u>zz', { desc = 'Fast up' })
vim.keymap.set('n', 'B', '^', { desc = 'Go to the begining of the line' })
vim.keymap.set('n', 'E', '$', { desc = 'Go to the end of the line' })
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'html', 'lua', 'markdown', 'vim', 'typescript', 'javascript', 'go', 'sql', 'elixir' },
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>e', ':NvimTreeToggle<CR>', { buffer = true, noremap = true })
    end,
    init = function()
      -- disable netrw
